...
object SeedData {
    val accounts = listOf(
        AccountEntity(name = "现金", colorArgb = 0xFF16A34A, iconName = "payments", sortOrder = 0),
        AccountEntity(name = "银行卡", colorArgb = 0xFF2563EB, iconName = "credit_card", sortOrder = 1),
        AccountEntity(name = "微信钱包", colorArgb = 0xFF059669, iconName = "chat", sortOrder = 2),
        AccountEntity(name = "支付宝", colorArgb = 0xFF0284C7, iconName = "account_balance_wallet", sortOrder = 3),
        AccountEntity(name = "Apple 账户余额", colorArgb = 0xFF52525B, iconName = "phone_iphone", sortOrder = 4),
        AccountEntity(name = "公交卡", colorArgb = 0xFFF97316, iconName = "directions_bus", sortOrder = 5),
        AccountEntity(name = "超市储值卡", colorArgb = 0xFF7C3AED, iconName = "storefront", sortOrder = 6)
    )
